...
namespace CreateQuotePost {
  export class UseCase implements UseCaseInterface<Input, Output> {
    ...
    async execute(
      input: CreateQuotePost.Input,
    ): Promise<CreateQuotePost.Output> {
      ...
      quotePost.quotePost(input.quote, {
        id: post.id,
      ...
      await this.postRepository.insert(quotePost);
      return quotePost.toJSON();
    }
  }
